...
for (const standaloneView of ["beta-feedback", "achievements-title", "codex-collection", "tutorial-guide", "chat-social", "party-recruit", "pet-companion", "equipment-enhance", "arena", "boss-preview", "dispatch-result", "battle-stats", "title-detail", "codex-detail", "appearance-collection", "badge-collection", "tutorial-battle", "tutorial-inventory", "tutorial-skills", "tutorial-guild", "daily-checkin", "pass-progress", "timed-challenge", "event-exchange-confirm", "character-bio", "region-reputation", "material-storage", "monster-drops", "guild-members", "guild-research", "party-tactics", "friend-support-detail", "class-specialization", "rune-config", "dungeon-prepare", "drop-settlement-detail"]) {
...
assert(script.includes('const ARG_PAGE_NAMES := ["home", "role", "packs", "market", "challenge", "guild", "system", "inventory", "skills", "shop", "quests", "ranking", "mail", "friends", "world", "account", "liveops", "feedback", "achievements", "codex", "tutorial", "chat", "party", "pets", "enhance", "arena", "boss_preview", "dispatch_result", "battle_stats", "title_detail", "codex_detail", "appearance_collection", "badge_collection", "tutorial_battle", "tutorial_inventory", "tutorial_skills", "tutorial_guild", "daily_checkin", "pass_progress", "timed_challenge", "event_exchange_confirm", "character_bio", "region_reputation", "material_storage", "monster_drops", "guild_members", "guild_research", "party_tactics", "friend_support_detail", "class_specialization", "rune_config", "dungeon_prepare", "drop_settlement_detail"]'), "Godot direct page startup must include secondary pages without crowding bottom nav");
