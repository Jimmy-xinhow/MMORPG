...
| RR-011 | Define release candidate smoke standard | Review | Standard defined; first RC execution still requires source control, CI, version, artifact, and naming decisions. |
